...
enum class TokenType { VAR, EQ, PLUS, MINUS, NUMBER, STRING, SEMICOLON, TAB,
	...
	IF_END, MULT, DIV, PRINT, COMMA, ARRAY, SQ_LEFT_BRACKET, SQ_RIGHT_BRACKET, ARR_LIST, BOOL, TRUE, FALSE,
	GREATER, LESS, AND, OR, FUNCTION, POINT, RETURN, FUNC_END, FUNC_INIT, INPUT, INT, MODULE,
